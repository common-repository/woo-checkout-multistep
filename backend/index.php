...
class Yeemail_Settings_Builder_Backend {
    ...
    function add_pro_notification($post_id){
        ...
        <div class="yeemail-message-notice-content">
            <div class="yeemail-message-notice-content-inner" style="text-align: center;"> 
                <span class="dashicons dashicons-warning"></span> <?php esc_html_e( "This email template can be fully customized with YeeMail Premium Addon.", "yeemail" ) ?> <strong><a href="https://add-ons.org/plugin/" target="_blank" style="color: rgb(127, 84, 179);"><?php esc_html_e("Buy Now","yeemail") ?></a></strong>
            </div>
        </div>
        <?php
        }
    ...
    function add_yeemail_template_to_subsubsub($views){
        ...
        switch ($mail_type){
            ...
            case "core":
                ...
                break;
            case "woocommerce":
                $class_woo = 'class="current"';
            case "edd":
                $class_edd = 'class="current"';
            break;
            case "other":
        ...
        $default_views["all"] =  sprintf(__('<a href="%s" '.$class_all.'>ALL<span class="count">(%d)</span></a>', 'yeemail' ), admin_url('edit.php?post_type=yeemail_template&mail_type=all'),$total_post);
        ...
        if(self::is_plugin_active("woocommerce")){
            $woocommerce_post = new WP_Query(array("posts_per_page"=>-1,"post_type"=>"yeemail_template","meta_key"=>"_mail_type","meta_value"=>"woocommerce"));
            $default_views["woocommerce"] = sprintf(__('<a href="%s" '.$class_woo.'>WooCommerce<span class="count">(%d)</span></a>', 'yeemail' ), admin_url('edit.php?post_type=yeemail_template&mail_type=woocommerce'), $woocommerce_post->post_count);
        }
        if(self::is_plugin_active("edd")){
            $edd_post = new WP_Query(array("posts_per_page"=>-1,"post_type"=>"yeemail_template","meta_key"=>"_mail_type","meta_value"=>"edd"));
            $default_views["edd"] = sprintf(__('<a href="%s" '.$class_edd.'>Easy Digital Downloads<span class="count">(%d)</span></a>', 'yeemail' ), admin_url('edit.php?post_type=yeemail_template&mail_type=edd'), $edd_post->post_count);
        }
        ...
        <div id="builder-header">
            <div id="header-right">
                ...
                <div class="header-right-r">
                    ...
                    <div class="">
                        <a class="button" target="_blank" href="<?php echo esc_url(wp_nonce_url(get_home_url() ."/?email_preview=preview&id=". $post_id ),"yeemail") ?>"><span class="dashicons dashicons-visibility"></span> <?php esc_html_e("Preview","yeemail")  ?></a>
                    </div>
                    <div class="">
                                    ...
                                    <div class="builder__widget--inner">
                                        <div class="builder__widget_tab builder__widget_genaral">
                                            ...
                                            <ul class="momongaPresets momongaPresets_data">
                                                <?php do_action( "yeemail_builder_tab_block" ) // phpcs:ignore WordPress.Security.EscapeOutput ?>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="builder__widget--inner">
                                        <div class="builder__widget_tab builder__widget_columns">
                                            ...
                                            <ul class="builder-row-tool momongaPresets_data">
                                                <?php do_action( "yeemail_builder_tab_block_row" ) // phpcs:ignore WordPress.Security.EscapeOutput ?>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="builder__widget--inner">
                                        <div class="builder__widget_tab builder__widget_templates">
                                            ...
                                            <ul class="builder-row-templates momongaPresets_data">
                                                <?php do_action( "yeemail_builder_tab_block_template" ) // phpcs:ignore WordPress.Security.EscapeOutput ?>
                                            </ul>
                                        </div>
                                    </div>
                                    <?php do_action( "yeemail_builder_tab_block_addons" ) // phpcs:ignore WordPress.Security.EscapeOutput ?>
                                </div>
                                <div class="tab__content" id="tab__editor">
                                    <div class="builder__editor">
                                        <?php do_action( "yeemail_builder_tab__editor" ) // phpcs:ignore WordPress.Security.EscapeOutput ?>
                                    </div>
                                </div>
                            </div>
    ...
    function style() {
        ...
        if(isset($post->post_type) && $post->post_type == "yeemail_template"){
            ...
            wp_enqueue_style('bootstrap-touchspin', YEEMAIL_PLUGIN_URL. "backend/libs/touchspin/jquery.bootstrap-touchspin.css");
            ...
            wp_enqueue_style('yeemail-momonga', YEEMAIL_PLUGIN_URL. "backend/css/momonga.css",array("wp-color-picker","thickbox","bootstrap-touchspin","wp-jquery-ui-dialog"),$ver);
            ...
            wp_register_script('bootstrap-touchspin', YEEMAIL_PLUGIN_URL."backend/libs/touchspin/jquery.bootstrap-touchspin.min.js");
            ...
            wp_enqueue_script('yeemail_script', YEEMAIL_PLUGIN_URL."backend/src/script.js",array("jquery","jquery-ui-core","jquery-ui-dialog","jquery-ui-sortable","jquery-ui-draggable","jquery-ui-droppable","wp-color-picker","wp-tinymce","yeemail-editor","thickbox","bootstrap-touchspin","jquery-effects-core","jquery-effects-scale"),$ver);
            $builder_shorcode = apply_filters("yeemail_builder_shortcode",array());
            $shortcodes = Builder_Email_Shortcode::list_shortcodes();
            $builder_shorcode_re ="";
            $i= 0;
    ...
    function save_metabox($post_id, $post) {
        if( isset($_POST['data_email'])) {
            update_post_meta($post_id,'data_email',$_POST['data_email']); //phpcs:ignore WordPress.Security.NonceVerification
        }
