...
class Yeemail_Addons_Gravity_Forms{
	...
	function add_settings($fields, $notification, $form){
        ...
        $from_email_warning = '<div class="alert warning" role="alert" style=""><a class="button" target="_blank" href="'.esc_url(get_edit_post_link($link)."&add-ons=gravity-forms").'">'.esc_attr__( "Customize with YeeMail", "yeemail").'</a></div>';
